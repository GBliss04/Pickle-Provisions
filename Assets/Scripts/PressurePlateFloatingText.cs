...
public class PressurePlateFloatingText : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (floatingTextPrefab != null)
        {
            ...
            FloatingTextController textController = floatingTextInstance.GetComponent<FloatingTextController>();
            if (textController != null)
            {
                textController.SetText(displayText);
                textController.target = transform; // Attach text to the pressure plate
            }
        }
        else
        {
